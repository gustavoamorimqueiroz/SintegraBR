...
namespace SintegraBr.Classes
{
    ...
    public class Registro54 : RegistroBaseSintegra
    {
        ...
        //alteração gustavo Campos(3, ... )  -> Campos(2, ...) 
        
        /// <summary>
        /// Série da nota fiscal
        /// </summary>
        [SintegraCampos(2, "SÉRIE", "X", 3, 0, true)]
        public string Serie { get; set; }

        /// <summary>
        /// Número da nota fiscal
        /// </summary>
        [SintegraCampos(2, "NÚMERO", "N", 6, 0, true)]
        public int Numero { get; set; }

        /// <summary>
        /// Código fiscal da operação ou prestação
        /// </summary>
        [SintegraCampos(2, "CFOP", "N", 4, 0, true)]
        public int Cfop { get; set; }

        /// <summary>
        /// Código da situação tributária
        /// </summary>
        [SintegraCampos(2, "CST", "X", 3, 0, true)]
        public string Cst { get; set; }

        /// <summary>
        /// Número de ordem do item na nota fiscal
        /// </summary>
        [SintegraCampos(2, "NÚMERO DO ITEM", "N", 3, 0, true)]
        public int NumeroItem { get; set; }

        /// <summary>
        /// Código do produto ou serviço do informante
        /// </summary>
        [SintegraCampos(2, "CÓDIGO PRODUTO/SERVIÇO", "X", 14, 0, true)]
        public string CodProdutoServico { get; set; }

        /// <summary>
        /// Quantidade do produto (com 3 decimais)
        /// </summary>
        [SintegraCampos(2, "QUANTIDADE", "N", 11, 3, true)]
        public decimal Quantidade { get; set; }
        //alteração gustavo quantidade: long -> decimal
        /// <summary>
        /// Valor bruto do produto (valor unitário multiplicado por quantidade) - com 2 decimais
        /// </summary>
        [SintegraCampos(2, "VALOR DO PRODUTO/SERVIÇO", "N", 12, 2, true)]
