...
namespace SintegraBr.Common
{
    public static class ExtensionMethods
    {
        ...
        /// <summary>
        /// Remove diacritics and normalize characters using the complete canonical decomposition.
        /// </summary>
        /// <param name="text">Text input.</param>
        /// <returns>Returns a normalized string .</returns>
        public static string ReplaceDiacritics(this string text)
        {
            string sourceInFormD = text.Normalize(NormalizationForm.FormD);
            var output = new StringBuilder();
            foreach (char c in from c in sourceInFormD
